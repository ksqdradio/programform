...
$personaData = array();
$dj_number = $show_info_array['persona'][0]; // at this point only first dj
...
window.onload = function() { window.document.body.onload = Ready($show_id_no)};</script>
<div id="dj_number" data-dj-number=$dj_number></div>
